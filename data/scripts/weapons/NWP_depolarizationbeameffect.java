...
public class NWP_depolarizationbeameffect implements BeamEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, BeamAPI beam) {
     ...
     /*       DamagingExplosionSpec depolarizeExplosion = new DamagingExplosionSpec(1f, 1f,
            1f, 500000f, 500000f, HITS_SHIPS_AND_ASTEROIDS, HITS_SHIPS_AND_ASTEROIDS, 1f, 1f, 1f,
